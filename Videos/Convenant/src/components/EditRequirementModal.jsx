...
const EditRequirementModal = ({ isOpen, onClose, onSubmit, requirement }) => {
  ...
  useEffect(() => {
    if (requirement && isOpen) {
      setFormData({
        ...
        formats: requirement.format ? requirement.format.split(', ') : []
      });
    }
  }, [requirement, isOpen]);
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        <div className="p-6">
          ...
          <p className="text-gray-600 mb-6">Edit information for this requirement</p>
            ...
            <div>
              ...
              <div className="flex gap-6">
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="edit-pdf" className="text-sm text-gray-700">
                    PDF
                  </label>
                </div>
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <label htmlFor="edit-jpeg" className="text-sm text-gray-700">
                    JPEG
                  </label>
                </div>
              </div>
